...
/**
 * Created by Elarion on 03.12.2016.
 */
public class MyMatrix implements SolverTask18.RectangularIntegerMatrix {
    int matrix[][];
    ...
    public MyMatrix(SolverTask18.RectangularIntegerMatrix matrix) {
    ...
    public MyMatrix getMaxMatrixWithUniqueElements() {
        getGreatestSubMatrix(matrix);
        return new MyMatrix(matrixStack.peek());
    }
